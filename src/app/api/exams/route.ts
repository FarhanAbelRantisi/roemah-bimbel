  ...
  try {
    ...
    const exam = await prisma.exam.create({
      data: {
        ...
        psikotestCategory: (examType === "PSIKOTEST" || examType === "PSIKOTEST_TNI") ? psikotestCategory : null,
        psikotestConfig: (examType === "PSIKOTEST" || examType === "PSIKOTEST_TNI") ? psikotestConfig : null,
